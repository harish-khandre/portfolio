...
export function TabsDemo() {
  ...
  return (
    <div className="h-[20rem] md:h-[36rem] [perspective:1000px] relative flex flex-col max-w-5xl mx-auto w-full items-start justify-start my-40 rounded-lg px-8 py-2 ">
      <Tabs tabs={tabs} />
    </div>
  );
}
